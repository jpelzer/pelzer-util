...
public final class Logging {
  ...
  static {
    ...
    final String muteString = System.getProperty("pelzer.mute");
    if (muteString != null && (muteString.equalsIgnoreCase("TRUE") || muteString.equalsIgnoreCase("YES")))
      mute = true;
    
    // Enable method-name logging?
    final String enableMethodNames = System.getProperty("pelzer.log.methods");
    if (enableMethodNames != null && (enableMethodNames.equalsIgnoreCase("TRUE") || enableMethodNames.equalsIgnoreCase("YES")))
      logMethodNames = true;
    ...
    // rootLogger.setLevel(Priority.WARN.getLevel());
